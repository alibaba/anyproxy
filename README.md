...
# [4.0.0-beta](../../tree/4.0.0-beta) published!

 *With Asynchronous rule API supported, and a new designed UI.*

 **want to get a full control over your requests and responses? Just write a rule and return a Promise.** You can find the [full API docs of v4.0Beta](../../blob/4.0.0-beta/doc/rule_api.md).
