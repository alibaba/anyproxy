...
function getIsRootCAFileExists(){
    return isRootCAFileExists = isRootCAFileExists == null ? certMgr.isRootCAFileExists() : isRootCAFileExists;
}
...
module.exports = {
    ...
    setInterceptFlag: function(flag){
        interceptFlag = flag && getIsRootCAFileExists();
    },
