  ...
  if (!!rawHeaders) {
    for (let i = 0; i < rawHeaders.length; i += 2) {
      ...
      if (!headerObj[key]) {
        ...
        // refer to http://stackoverflow.com/a/4371395, combine them in comma style
        headerObj[key] = headerObj[key] + ', ' + value;
        // there could be multiple set-cookie in the header, we combine them to an array
        // if (false && key.toLowerCase() === 'set-cookie') {
