...
const rule = require('./test_rules/test_rule_replace_request_data.js');
...
function testWrapper(protocol) {
    describe('Rule replaceRequestData should be working in :' + protocol, () => {
        ...
        beforeAll((done) => {
            ...
            printLog('Start server for test_rule_replace_request_data_spec');
        ...
        afterAll(() => {
            ...
            printLog('Close server for test_rule_replace_request_data_spec');
        });
