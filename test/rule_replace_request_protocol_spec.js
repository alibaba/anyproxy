...
function testWrapper() {
    describe('Rule replaceRequestProtocol should be working', () => {
        ...
        beforeAll((done) => {
            ...
            printLog('Start server for test_rule_replace_request_protocol_spec');
        ...
        afterAll(() => {
            ...
            printLog('Close server for test_rule_replace_request_protocol_spec');
        });
