...
const rule = require('./test_rules/test_rule_replace_response_header.js');
...
function testWrapper(protocol) {
    describe('Rule replaceResponseHeader should be working in :' + protocol, () => {
        ...
        beforeAll((done) => {
            ...
            printLog('Start server for test_rule_replace_response_header_spec');
        ...
        afterAll(() => {
            ...
            printLog('Close server for test_rule_replace_response_header_spec');
        });
