...
const rule = require('./test_rules/test_rule_replace_response_status_code.js');
...
function testWrapper(protocol) {
    describe('Rule replaceResponseStatus should be working in :' + protocol, () => {
        ...
        beforeAll((done) => {
            ...
            printLog('Start server for test_rule_replace_response_statusCode_spec');
        ...
        afterAll(() => {
            ...
            printLog('Close server for test_rule_replace_response_statusCode_spec');
        });
